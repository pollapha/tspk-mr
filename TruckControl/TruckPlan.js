    ...
    function loadData2(btn) {
        ajax(fd, {}, 2, function (json) {
            if (json.data.header.length > 0) {
                ...
                // ele('dataManageRoute').hideColumn("icon_check");
                                                        ...
                                                        cols: [
                                                            {
                                                                ...
                                                                columns: [
                                                                    ...
                                                                    { id: "Status_Pickup", header: [{ text: "Pickup/", css: { "text-align": "center" } }, { text: "Delivery", css: { "text-align": "center" } }], width: 80, css: { "text-align": "center" }, editor: "", options: Status_Pickup, },
                                                                    {
                                                                        id: "save", header: "",
                                                    ...
                                                    cols: [
                                                        {
                                                            ...
                                                            body:
                                                            {
                                                                ...
                                                                columns: [
                                                                    ...
                                                                    { id: "Sum_Qty", header: [{ text: "Qty(Pcs.)", css: { "text-align": "center" } },], width: 70, css: { "text-align": "center" }, hidden: 0, editor: "text", },
                                                                    ...
                                                                    //{ id: "save_qty_package", header: "", template: "<button class='mdi mdi-plus-circle-outline webix_button' style='width:25px; height:20px; color:#556892; background-color: #dadee0;'></button>", width: 40, css: { "text-align": "left" }, },
                                                                ...
                                                                onClick:
                                                                {
                                                                    ...
                                                                    "mdi-plus-circle-outline": function (e, t) {
                                                                        //var row1 = ele('dataManageRoute').getSelectedItem();
                                                                        //console.log(row1);
                                                                        var row2 = this.getItem(t);
                                                                        //console.log(row);
                                                                        var obj1 = ele('form1').getValues();
                                            ...
                                            [
                                                { height: 20 },
                                                {
                                                    cols: [
                                                        ...
                                                        {},
                                                        vw1('button', 'btn_delete_order', 'Delete All', {
                                                            width: 120, css: "webix_secondary",
                                                            icon: "mdi mdi-trash-can", type: "icon",
                                                            tooltip: { template: "เพิ่มข้อมูล", dx: 10, dy: 15 },
                                                            disabled: false,
                                                            hidden: 1,
                                                            on: {
