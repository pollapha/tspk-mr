                                ...
                                },
                                {
                                    ...
                                    columns:
                                        [
                                            ...
                                            { id: "Actual_Qty", header: [{ text: "Qty", css: { "text-align": "center" } }, { content: "textFilter" }], width: 60, css: { "text-align": "center" }, },
                                            { id: "Package_Qty", header: [{ text: "Package Qty", css: { "text-align": "center" } }, { content: "textFilter" }], width: 100, css: { "text-align": "center" }, },
                                            { id: "CBM", header: [{ text: "CBM", css: { "text-align": "center" } }, { content: "textFilter" }], width: 60, css: { "text-align": "center" }, },
                                            { id: "SNP_Per_Pallet", header: [{ text: "SNP/Pallet", css: { "text-align": "center" } }, { content: "textFilter" }], width: 100, css: { "text-align": "center" }, },
